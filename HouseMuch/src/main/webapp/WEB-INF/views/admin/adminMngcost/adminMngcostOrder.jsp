	...
	$(function(){
		...
		$('#btMngcostPayOrder').click(function(){
			if($('#startdate').val().length==0){
				...
				if(confirm("청구 기한이 지난 내역입니다. 사용월 기준 말일로 청구를 진행시겠습니까?")){
			      ...
			      <div class="card">
			        <div class="card-body">
			          ...
			          <form id="frmMngcostPayOrder" method="post" action="<c:url value='/admin/adminMngcost/adminMngcostOrder.do'/>" >
				          <input type="text" name="mngcostClaimdate" id="mngcostClaimdate">
				          <input type="text" class="form-control" placeholder="사용년월 선택"
				          		name="startdate" id="startdate" value="${param.useMonth}" disabled="disabled"><br>
					      <label>납부기한</label>
